...
export const HUBS = [
  /* ── Frachtflughäfen ── */
  { name: 'Flughafen Frankfurt, Frachtzentrum Süd', lat: 50.0379, lon:  8.5622, art: 'Flughafen',    bonus: 1.25 },
  ...
  { name: 'Flughafen München, Luftfrachtzentrum',      lat: 48.3538, lon: 11.7861, art: 'Flughafen',    bonus: 1.22 },
  ...
  /* ── Binnenhäfen ── */
  { name: 'Binnenhafen Duisburg, Logistikzentrum',        lat: 51.4400, lon:  6.7200, art: 'Binnenhafen',  bonus: 1.24 },
  ...
  { name: 'Terminal Ludwigshafen Rheinufer',         lat: 49.4800, lon:  8.4300, art: 'Güterbahnhof', bonus: 1.13 },
